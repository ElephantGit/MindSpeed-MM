...
class WanVAE_(nn.Module):
    ...
    def clear_cache(self):
        # Native preprocessing may intentionally discard the unused decoder to
        # reduce accelerator memory.  Encoding still calls clear_cache before
        # and after each sample, so keep the decoder cache optional.
        self._conv_num = count_conv3d(self.decoder) if hasattr(self, "decoder") else 0
        self._conv_idx = [0]
