...
export LANCE_OVERFIT_CE_WEIGHT="${LANCE_OVERFIT_CE_WEIGHT:-0.0}"
...
echo "Optimization: iters=${LANCE_TRAIN_ITERS}, warmup=${LANCE_WARMUP_STEPS}, lr=${LANCE_OVERFIT_LR}, schedule=${LANCE_OVERFIT_LR_DECAY_STYLE}, lr_min=${LANCE_OVERFIT_LR_MIN}, ce_weight=${LANCE_OVERFIT_CE_WEIGHT}, mse_weight=${LANCE_OVERFIT_MSE_WEIGHT}, ema=${LANCE_OVERFIT_USE_EMA}"
